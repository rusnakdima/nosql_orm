...
impl ClickHouseProvider {
  pub async fn connect(_connection_string: impl Into<String>) -> OrmResult<Self> {
    Err(OrmError::Provider(
      "ClickHouse not yet implemented".to_string(),
    ))
  }
...
#[async_trait]
impl SchemaIntrospection for ClickHouseProvider {
...
#[async_trait]
impl AdminCommands for ClickHouseProvider {
...
#[async_trait]
impl TransactionControl for ClickHouseProvider {

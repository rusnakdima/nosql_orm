...
impl DynamoProvider {
  pub async fn connect(
    _connection_string: impl Into<String>,
    _region: impl Into<String>,
  ) -> OrmResult<Self> {
    Err(OrmError::Provider(
      "DynamoDB not yet implemented".to_string(),
    ))
  }

  pub fn new(_connection_string: impl Into<String>, _region: impl Into<String>) -> Self {
    Self {
...
#[async_trait]
impl DatabaseProvider for DynamoProvider {
...
#[async_trait]
impl SchemaIntrospection for DynamoProvider {
...
#[async_trait]
impl AdminCommands for DynamoProvider {
...
#[async_trait]
impl TransactionControl for DynamoProvider {
